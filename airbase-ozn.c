/*
 * 802.11 monitör erişim noktası
 * airtun-ozn'ye dayalı
 *
 * 
 *
 ...
 * Foundation, Inc., İnönü Mahallesi, Yenimahalle, Batıkent, Ankara, Türkiye.
 *
 *
...
#include "securtycrack-ozn/third-party/eapol.h"

#include "securtycrack-ozn/defs.h"
#include "securtycrack-ozn/support/communications.h"
#include "securtycrack-ozn/support/fragments.h"
...
static const char usage[]
	= "\n"
	  "  usage: airbon-ozn <options> <replay interface>\n"
	  "\n"
	  "  Options:\n"
	  "\n"
...
#include "securtycrack-ozn/support/station.h"
	...
	if (argc - optind != 1)
	{
		...
		usage:
			printf(
				usage,
				getVersion(
					"Airbase-ozn", _MAJ, _MIN, _SUB_MIN, _REVISION, _BETA, _RC));
		}
		if (argc - optind == 0)
		{
